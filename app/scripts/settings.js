...
.factory('settings', function () {
    ...
    return {
        ...
        remote: {
            ...
            LEAFLET_BACKGROUND_URL: 'http://rando.ecrins-parcnational.fr/tiles?LAYER=GEOGRAPHICALGRIDSYSTEMS.MAPS&EXCEPTIONS=text/xml&FORMAT=image/jpeg&SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&STYLE=normal&TILEMATRIXSET=PM&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}'
        },
        device: {
            CDV_ROOT: CDV_ROOT,
